        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">contact@yourbrand.com</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">123 Business Street<br />San Francisco, CA 94102</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-blue-50 rounded-lg">
              <h4 className="text-xl mb-2 text-gray-900">Business Hours</h4>
